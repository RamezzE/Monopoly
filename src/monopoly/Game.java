...
public class Game {
    ...
    public static EnteringPlayerData enterDataScreen;
    public static PlayScreen playScreen;

    public static Stage primaryStage;

    public static Button[] back, go;
    public static ImageView[] logo = new ImageView[6];

    public static Image boardImage = new Image("file:assets\\imgs\\monopoly.jpg");

    public static double screenHeight = boardImage.getHeight();
    public static double screenWidth = boardImage.getWidth();

    private static final String lastPlayerQueueFile = "assets\\files\\playerQueue.txt";
    ...
    public void initializeVariables() {
        ...
        for (short i = 0; i < 6; i++) {
            ...
            back[i].setStyle("-fx-background-color: transparent;-fx-cursor: hand; -fx-background-radius: 15px; -fx-text-fill: #ffffff");
    ...
    public static void initializeBoard() throws Exception {
        ...
        Board.add(32, new Property(32, "North Carolina Avenue", "Green", 300, 26, 130, 390, 900, 1100, 1275, 200, 150, 3));

        Board.add(33, new OtherTiles("chest"));

        Board.add(34, new Property(34, "Pennsylvania Avenue", "Green", 320, 28, 150, 450, 1000, 1200, 1400, 200, 160, 3));
...
//        
    ...
    private static void saveCurrentBoardData() {
    ...
    private static void saveCurrentPlayerQueue() {

        //saves Queue of current Game
        String data = "";
        for (int i = 0; i < playScreen.playersCount; i++) {
            data += playScreen.playerQueue.front() + " ";
    ...
    private static void reloadPlayerQueue() throws Exception {
    ...
    private static void reloadBoardData() throws Exception {
